...
-t docker.pkg.github.com/queueing-systems-assistance/qsa-frontend/qsa-frontend:"${RELEASE_VERSION}" . || exit

sudo docker push docker.pkg.github.com/queueing-systems-assistance/qsa-frontend/qsa-frontend:"${RELEASE_VERSION}" || exit
