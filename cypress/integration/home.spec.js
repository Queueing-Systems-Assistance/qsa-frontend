...
describe('Home', () => {
    ...
    it('has a systems scrollable layout', () => {
        cy.get('home-systems-component').should('exist')
    })

    it('has a kendall notation', () => {
        cy.get('home-kendall-component').should('exist')
    })

    it('can select kendall notation characters', () => {
        cy.get('home-kendall-component > div > a:nth-child(3)').should(
            'not.have.class',
            'active'
        )
    ...
    it('can select system schemes', () => {
        ...
        cy.get('home-selection-component > div').first().click({ force: true })
