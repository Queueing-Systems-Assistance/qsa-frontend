describe('Documentation', () => {
    ...
    it('has section url', () => {
        cy.get('documentation-url-component').should('exist')
    })

    it('has section parameter table', () => {
        cy.get('documentation-table-component').should('exist')
    })

    it('has section examples', () => {
        cy.get('documentation-example-component').should('exist')
    })
    ...
    function testSection(sectionId) {
        cy.get('[data-target="#' + sectionId + '"]').should('exist')
    }
})
