...
export class CompareTableSelectionComponent implements OnInit {
    ...
    private createTableViewCompare(): TableViewCompare {
        const tableViews = CompareTableSelectionComponent.copyObject(this.getSelectedTableView())
        const tabNames = CompareTableSelectionComponent.copyObject(this.getTableViewSelectedTabNames())
