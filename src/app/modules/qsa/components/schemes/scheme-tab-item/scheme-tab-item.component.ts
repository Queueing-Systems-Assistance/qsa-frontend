...
export class SchemeTabItem {
    ...
    private updateTablesService(): void {
        ...
        this.shiftValues(this.tablesService.getSystemViewsForms(), (currentIndex) => this.tablesService.getSystemViewsForm(currentIndex));
        this.shiftValues(this.tablesService.getSystemViewInputsAll(), (currentIndex) => this.tablesService.getSystemViewInputs(currentIndex));
        this.shiftValues(this.tablesService.getSystemViewInputsAll(), (currentIndex) => this.tablesService.getSystemViewInputs(currentIndex));
        this.shiftValues(this.tablesService.getTableViews(), (currentIndex) => this.tablesService.getTableView(currentIndex));
        this.shiftValues(this.tablesService.getSystemViews(), (currentIndex) => this.tablesService.getSystemView(currentIndex));
    }
    ...
    private updateChartService(): void {
        ...
        this.shiftValues(this.chartsService.getSystemViewsForms(), (currentIndex) => this.chartsService.getSystemViewsForm(currentIndex));
        this.shiftValues(this.chartsService.getSystemViewInputsAll(), (currentIndex) => this.chartsService.getSystemViewInputs(currentIndex));
        this.shiftValues(this.chartsService.getSystemViewInputsAll(), (currentIndex) => this.chartsService.getSystemViewInputs(currentIndex));
        this.shiftValues(this.chartsService.getSystemViews(), (currentIndex) => this.chartsService.getSystemView(currentIndex));
        this.shiftValues(this.chartsService.getChartDatas(), (currentIndex) => this.chartsService.getChartData(currentIndex));
    }

    private updateCompareTable(): void {
        this.compareTableService.removeTableViewCompare(this.index);
        this.shiftValues(this.compareTableService.getTableViewCompares(), (currentIndex) => this.compareTableService.getTableViewCompare(currentIndex));
    }
