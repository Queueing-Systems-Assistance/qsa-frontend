...
export class SchemeTabItem {
        ...
        this.modalService.open(TabDeleteModal).result.then(
            (result) => {
                ...
                if (result) {
                    ...
                    this.router.navigate([this.index - 1], {
    ...
    public onChangeTabType(): void {
        this.modalService.open(TabChangeModal).result.then(
            (result) => {
                ...
                if (result) {
                    this.schemesService.getTabs()[this.index].type =
                        TabType.DEFAULT
                    this.updateCachedData()
                }
            },
    ...
    private updateTablesService(): void {
        ...
        this.shiftValues(
            this.tablesService.getSystemViewsForms(),
            (currentIndex) =>
                this.tablesService.getSystemViewsForm(currentIndex)
        )
        this.shiftValues(
            this.tablesService.getSystemViewInputsAll(),
            (currentIndex) =>
    ...
    private updateChartService(): void {
        ...
        this.shiftValues(
            this.chartsService.getSystemViewsForms(),
            (currentIndex) =>
                this.chartsService.getSystemViewsForm(currentIndex)
        )
        this.shiftValues(
            this.chartsService.getSystemViewInputsAll(),
            (currentIndex) =>
    ...
    private updateCompareTable(): void {
        ...
        this.shiftValues(
            this.compareTableService.getTableViewCompares(),
            (currentIndex) =>
