...
export class BackendService {
    ...
    public getInput(systemId: string): Observable<Array<SystemFeature>> {
        ...
        return this.http.get<Array<SystemFeature>>(
            environment.apiUrl + '/systems/' + systemId,
            { params }
        )
    }
    ...
    public getTable(values, systemId): Observable<TableView> {
        ...
        return this.http.post<TableView>(
            this.SYSTEM_TABLE_API + '/' + systemId,
            values,
            { params }
        )
    }
    ...
    public getChart(values, systemId, xAxisFeatureId): Observable<ChartData> {
        ...
        return this.http.post<ChartData>(
            this.CHART_API + '/' + systemId + '/' + xAxisFeatureId,
            values,
            { params }
        )
    }
    ...
    private getParams(): HttpParams {
        return new HttpParams().set(
            'locale',
            LocaleHelper.getCorrectLocale(this.translateService)
        )
    }
}
