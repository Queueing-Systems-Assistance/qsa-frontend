...
export class TablesService {
    ...
    public addSystemInputsForm(index: number, systemInputForm: FormGroup): void {
    ...
    public addSystemViewInputs(index: number, systemViewInputs: Array<SystemFeature>): void {
